...
function inViewport (el) {
  const options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { tolerance: 0 }
...
function inContainer (el) {
  let options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { tolerance: 0, container: '' }
...
function eventHandler () {
  const trackedElements = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}
  const options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { tolerance: 0 }

  const selectors = Object.keys(trackedElements)
  let testVisibility = void 0
 ...
 */
function OnScreen () {
  const options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { tolerance: 0, debounce: 100, container: window }
