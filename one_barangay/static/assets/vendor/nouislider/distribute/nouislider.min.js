!(function (t, e) {
  ...
  (st.PipsMode = void 0),
    ((H = st.PipsMode || (st.PipsMode = {})).Range = "range"),
    (H.Steps = "steps"),
    (H.Positions = "positions"),
    (H.Count = "count"),
    (H.Values = "values"),
    (st.PipsType = void 0),
    ((H = st.PipsType || (st.PipsType = {}))[(H.None = -1)] = "None"),
  ...
  var u =
    ((t.prototype.getDistance = function (t) {
      for (var e = [], r = 0; r < this.xNumSteps.length - 1; r++) {
        ...
        if (n && (t / n) % 1 != 0)
          throw new Error(
            "noUiSlider: 'limit', 'margin' and 'padding' of " + this.xPct[r] + "% range must be divisible by step."
          );
        e[r] = a(this.xVal, t, r);
      }
      return e;
  ...
  function j(t, f, o) {
    ...
    function C(t, e) {
      ...
      return (
        ...
        0 === e ? dt(n, f.cssClasses.handleLower) : e === f.handles - 1 && dt(n, f.cssClasses.handleUpper),
        t
      );
    }
    function N(t, e) {
      ...
      return (
        ...
        h.forEach(function (t, e) {
          ...
          for (void 0 === c && (c = t), f = Math.max(f, 1e-7), r = t; r <= c; r = Number((r + f).toFixed(7))) {
            ...
            (a = -1 < h.indexOf(r) ? st.PipsType.LargeValue : p ? st.PipsType.SmallValue : st.PipsType.NoValue),
              !e && g && r !== c && (a = 0),
    ...
    function O(i, o, s) {
      var t,
        ...
        n =
          (((t = {})[st.PipsType.None] = ""),
          (t[st.PipsType.NoValue] = f.cssClasses.valueNormal),
          (t[st.PipsType.LargeValue] = f.cssClasses.valueLarge),
          (t[st.PipsType.SmallValue] = f.cssClasses.valueSub),
          t),
        l =
          (((t = {})[st.PipsType.None] = ""),
          (t[st.PipsType.NoValue] = f.cssClasses.markerNormal),
          (t[st.PipsType.LargeValue] = f.cssClasses.markerLarge),
          (t[st.PipsType.SmallValue] = f.cssClasses.markerSub),
          t),
      ...
      return (
        dt(a, f.cssClasses.pips),
        dt(a, 0 === f.ort ? f.cssClasses.pipsHorizontal : f.cssClasses.pipsVertical),
        Object.keys(i).forEach(function (t) {
          var e, r, n;
          (r = i[(e = t)][0]),
            (n = i[t][1]),
            (n = o ? o(r, n) : n) !== st.PipsType.None &&
              (((t = P(a, !1)).className = p(n, f.cssClasses.marker)),
              (t.style[f.style] = e + "%"),
              n > st.PipsType.NoValue &&
    ...
    function _(t, e) {
      e.handle && (ht(e.handle, f.cssClasses.active), --v),
        e.listeners.forEach(function (t) {
          y.removeEventListener(t[0], t[1]);
        }),
        0 === v &&
          (ht(d, f.cssClasses.drag),
          Q(),
          t.cursor && ((w.style.cursor = ""), w.removeEventListener("selectstart", ut))),
    ...
    function B(t, e) {
      ...
      e.handleNumbers.some(k) ||
        (1 === e.handleNumbers.length &&
          ((o = a[e.handleNumbers[0]].children[0]), (v += 1), dt(o, f.cssClasses.active)),
        t.stopPropagation(),
        (n = z(c.move, y, R, {
          target: t.target,
          handle: o,
        ...
        t.cursor &&
          ...
          1 < a.length && dt(d, f.cssClasses.drag),
          w.addEventListener("selectstart", ut, !1)),
        e.handleNumbers.forEach(function (t) {
          W("start", t);
        }));
    }
    function q(t) {
      ...
      var i,
        ...
        r =
          ...
          s);
      !1 !== r &&
        (f.events.snap || ct(d, f.cssClasses.tap, f.animationDuration),
        Z(r, e, !0, !0),
        Q(),
        W("slide", r, !0),
        W("update", r, !0),
        f.events.snap ? B(t, { handleNumbers: [r] }) : (W("change", r, !0), W("set", r, !0)));
    }
    function X(t) {
      var t = H(t.calcPoint),
        t = S.getStep(t),
    ...
    function $(t, e, r, n, i, o) {
      ...
      return (
        1 < a.length &&
          ...
          (n && 0 < e && ((s = S.getAbsoluteDistance(t[e - 1], f.margin, !1)), (r = Math.max(r, s))),
          i && e < a.length - 1 && ((s = S.getAbsoluteDistance(t[e + 1], f.margin, !0)), (r = Math.min(r, s)))),
        1 < a.length &&
          f.limit &&
          (n && 0 < e && ((s = S.getAbsoluteDistance(t[e - 1], f.limit, !1)), (r = Math.min(r, s))),
          i && e < a.length - 1 && ((s = S.getAbsoluteDistance(t[e + 1], f.limit, !0)), (r = Math.max(r, s)))),
        f.padding &&
          (0 === e && ((s = S.getAbsoluteDistance(0, f.padding[0], !1)), (r = Math.max(r, s))),
          e === a.length - 1 && ((s = S.getAbsoluteDistance(100, f.padding[1], !0)), (r = Math.min(r, s)))),
        !((r = pt((r = S.getStep(r)))) === t[e] && !o) && r
      );
    }
    function G(t, e) {
      var r = f.ort;
    ...
    function Z(t, e, r, n, i) {
      return (
        ...
        (e = "translate(" + G(10 * (K(e, 0) - E) + "%", "0") + ")"),
        (a[t].style[f.transformRule] = e),
        tt(t),
        tt(t + 1),
        !0)
      );
    ...
    function tt(t) {
      ...
      l[t] &&
        ...
        (e =
          "translate(" +
          G(K((e = (e = 0) !== t ? m[t - 1] : e), (r = (r = t !== l.length - 1 ? m[t] : r) - e)) + "%", "0") +
          ")"),
        (r = "scale(" + G(r / 100, "1") + ")"),
        (l[t].style[f.transformRule] = e + " " + r));
    }
    function et(t, e) {
    ...
    function rt(t, e, r) {
      var n = ft(t),
        t = void 0 === m[0];
      (e = void 0 === e || e),
        f.animate && !t && ct(d, f.cssClasses.tap, f.animationDuration),
        g.forEach(function (t) {
          Z(t, et(n[t], t), !0, !1, r);
        });
      var i,
    ...
    dt((e = d), f.cssClasses.target),
      0 === f.dir ? dt(e, f.cssClasses.ltr) : dt(e, f.cssClasses.rtl),
      0 === f.ort ? dt(e, f.cssClasses.horizontal) : dt(e, f.cssClasses.vertical),
      dt(e, "rtl" === getComputedStyle(e).direction ? f.cssClasses.textDirectionRtl : f.cssClasses.textDirectionLtr),
      (i = P(e, f.cssClasses.base)),
      (function (t, e) {
      ...
      f.tooltips && A(),
      I("update" + gt.aria),
      Y("update" + gt.aria, function (t, e, o, r, s) {
        g.forEach(function (t) {
          var e = a[t],
            r = $(m, t, 0, !0, !0, !0),
            n = $(m, t, 100, !0, !0, !0),
