...
(function () {
  ...
  const FONT_FAMILY_PATTERN = /Font Awesome ([5 ]*)(Solid|Regular|Light|Duotone|Brands|Free|Pro|Kit).*/i
  ...
  function makeInlineSvgAbstract (params) {
    ...
    const widthClass = isUploadedIcon ? '' : 'fa-w-'.concat(Math.ceil(width / height * 16))
