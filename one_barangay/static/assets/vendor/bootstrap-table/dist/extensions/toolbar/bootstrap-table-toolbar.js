(function (global, factory) {
  ...
  */
  ...
  const createMethod$1 = function (TO_ENTRIES) {
    return function (it) {
  ...
  $__default.default.BootstrapTable = /* #__PURE__ */(function (_$$BootstrapTable) {
    ...
    _createClass(_class, [{
      ...
      value: function showAvdSearch () {
        ...
        const o = this.options
        const modalSelector = '#avdSearchModal_'.concat(o.idTable)
      ...
      value: function showModal () {
        const modalSelector = '#avdSearchModal_'.concat(this.options.idTable)
      ...
      value: function hideModal () {
        const $closeModalButton = $__default.default('#avdSearchModal_'.concat(this.options.idTable))
        const modalSelector = '#avdSearchModal_'.concat(this.options.idTable)
      ...
      value: function createFormAvd () {
        const o = this.options
        const html = ['<form class="form-horizontal" id="'.concat(o.idForm, '" action="').concat(o.actionForm, '">')]
      ...
      value: function initSearch () {
        ...
        const fp = $__default.default.isEmptyObject(this.filterColumnsPartial) ? null : this.filterColumnsPartial
        this.data = fp ? this.data.filter(function (item, i) {
          for (let _i = 0, _Object$entries = Object.entries(fp); _i < _Object$entries.length; _i++) {
            const _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2)
            const key = _Object$entries$_i[0]
            const v = _Object$entries$_i[1]

            const fval = v.toLowerCase()
            let value = item[key]

            const index = _this2.header.fields.indexOf(key)
      ...
      value: function onColumnAdvancedSearch (e) {
        const text = $__default.default.trim($__default.default(e.currentTarget).val())
        const $field = $__default.default(e.currentTarget)[0].id
