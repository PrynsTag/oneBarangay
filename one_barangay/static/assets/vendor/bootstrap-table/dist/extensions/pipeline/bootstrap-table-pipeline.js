(function (global, factory) {
  ...
  BootstrapTable.prototype.onPageListChange = function (event) {
	  ...
	  const target = $__default.default(event.currentTarget)
  ...
  BootstrapTable.prototype.drawFromCache = function (offset, limit) {
	  ...
	  const res = $__default.default.extend(true, {}, this.cacheRequestJSON)
	    ...
	    if (this.options.pagination && this.options.sidePagination === 'server') {
	      ...
	      if (this.options.usePipeline) {
	        ...
	        if (!this.cacheWindows.length) {
	          ...
	          const w = this.cacheWindows[this.currWindow] // case 1: reset cache but stay within current window (e.g. column sort)
