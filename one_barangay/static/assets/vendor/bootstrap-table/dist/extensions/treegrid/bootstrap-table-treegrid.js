  ...
  $__default.default.BootstrapTable = /* #__PURE__ */(function (_$$BootstrapTable) {
    ...
    _createClass(_class, [{
      ...
      value: function initHeader () {
        ...
        if (treeShowField) {
          const _iterator = _createForOfIteratorHelper(this.header.fields)
          let _step
      ...
      value: function initTr (item, idx, data, parentDom) {
        ...
        const nodes = data.filter(function (it) {
        ...
        for (let i = 0; i <= len; i++) {
          const node = nodes[i]
          const defaultItem = $__default.default.extend(true, {}, item)
          ...
          this.options.rowStyle = function (item, idx) {
            const res = _this._rowStyle(item, idx)

            const id = item[_this.options.idField] ? item[_this.options.idField] : 0
            const pid = item[_this.options.parentIdField] ? item[_this.options.parentIdField] : 0
      ...
      value: function initRow (item, idx, data, parentDom) {
        ...
        if (this.treeEnable) {
          if (this.options.rootParentId === item[this.options.parentIdField] || !item[this.options.parentIdField]) {
            ...
            this.options.rowStyle = function (item, idx) {
              const res = _this2._rowStyle(item, idx)

              const x = item[_this2.options.idField] ? item[_this2.options.idField] : 0
