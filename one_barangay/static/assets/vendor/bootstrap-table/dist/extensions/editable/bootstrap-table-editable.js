    ...
    _createClass(_class, [{
      ...
      value: function initTable () {
        ...
        $__default.default.each(this.columns, function (i, column) {
          ...
          const processDataOptions = function processDataOptions (key, value) {
            // Replace camel case with dashes.
            const dashKey = key.replace(/([A-Z])/g, function ($1) {
          ...
          column.formatter = function (value, row, index) {
            ...
            if (_this.options.uniqueId !== undefined && !column.alwaysUseFormatter) {
              const uniqueId = Utils.getItemField(row, _this.options.uniqueId, false)
            ...
            const editableOpts = Utils.calculateObjectValue(column, column.editable, [index, row], {})
      ...
      value: function initBody (fixedScroll) {
        ...
        $__default.default.each(this.columns, function (i, column) {
          ...
          const data = _this2.getData({
            escape: true
          })

          const $field = _this2.$body.find('a[data-name="'.concat(column.field, '"]'))
          ...
          $field.each(function (i, element) {
            ...
            const editableOpts = Utils.calculateObjectValue(column, column.editable, [index, row, $element], {})
            $element.editable(editableOpts)
          })
          $field.off('save').on('save', function (_ref, _ref2) {
            const currentTarget = _ref.currentTarget
            let submitValue = _ref2.submitValue
            ...
            if (_this2.options.uniqueId !== undefined && !column.alwaysUseFormatter) {
              const uniqueId = Utils.getItemField(row, _this2.options.uniqueId, false)
      ...
      value: function getData (params) {
        const data = _get(_getPrototypeOf(_class.prototype), 'getData', this).call(this, params)
        ...
        if (params && params.escape) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              for (let _i = 0, _Object$entries = Object.entries(row); _i < _Object$entries.length; _i++) {
