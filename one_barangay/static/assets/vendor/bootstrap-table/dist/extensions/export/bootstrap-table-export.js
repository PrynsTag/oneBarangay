    ...
    return [
      ...
      function (regexp, replaceValue) {
        ...
        for (let i = 0; i < results.length; i++) {
          ...
          const position = max$1(min(toInteger(result.index), S.length), 0)
          const captures = []
  ...
  $__default.default.BootstrapTable = /* #__PURE__ */(function (_$$BootstrapTable) {
    ...
    _createClass(_class, [{
      ...
      value: function initToolbar () {
        ...
        let $menu = $__default.default(this.constants.html.toolbarDropdown.join(''))
        ...
        if (exportTypes.length > 1) {
          ...
          const _iterator = _createForOfIteratorHelper(exportTypes)
          let _step
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              if (TYPE_NAME.hasOwnProperty(type)) {
                const $item = $__default.default(Utils.sprintf(this.constants.html.pageDropdownItem, '', TYPE_NAME[type]))
        ...
        $items.click(function (e) {
          e.preventDefault()
          const type = $__default.default(e.currentTarget).data('type')
          const exportOptions = {
            type: type,
            escape: false
          }
      ...
      value: function exportTable (options) {
        ...
        const doExport = function doExport (callback) {
          if (stateField) {
          ...
          if (o.detailView && o.detailViewIcon) {
            const detailViewIndex = o.detailViewAlign === 'left' ? 0 : _this2.getVisibleFields().length + Utils.getDetailViewIndexOffset(_this2.options)
            o.exportOptions.ignoreColumn = [detailViewIndex].concat(o.exportOptions.ignoreColumn || [])
          }

          if (o.exportFooter) {
            const $footerRow = _this2.$tableFooter.find('tr').first()

            const footerData = {}
            const footerHtml = []
            $__default.default.each($footerRow.children(), function (index, footerCell) {
              const footerCellHtml = $__default.default(footerCell).children('.th-inner').first().html()
            ...
            const $lastTableRow = _this2.$body.children().last()
          ...
          const hiddenColumns = _this2.getHiddenColumns()
