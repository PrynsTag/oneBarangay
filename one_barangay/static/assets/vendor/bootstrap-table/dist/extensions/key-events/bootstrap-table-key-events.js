    ...
    _createClass(_class, [{
      ...
      value: function initKeyEvents () {
        ...
        $__default.default(document).off('keydown').on('keydown', function (e) {
          const $search = Utils.getSearchInput(_this)

          const $refresh = _this.$toolbar.find('button[name="refresh"]')

          const $toggle = _this.$toolbar.find('button[name="toggle"]')

          const $paginationSwitch = _this.$toolbar.find('button[name="paginationSwitch"]')
